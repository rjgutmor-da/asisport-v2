...
backup.forEach(a => {
    sql += `
    INSERT INTO alumnos (nombres, apellidos, fecha_nacimiento, escuela_id, sucursal_id, grupo_id, horario_id, foto_url, nombre_padre, telefono_padre, whatsapp_preferido, estado, created_by, archivado)
    VALUES ('${a.nombres}', '${a.apellidos}', '${a.fecha_nacimiento}', '${ESCUELA_ID}', '${SUCURSAL_ID}', '${GRUPO_ID}', '${HORARIO_ID}', ${a.foto_url ? `'${a.foto_url}'` : 'NULL'}, 'Representante', '59174631123', 'padre', 'Aprobado', '${ENTRENADOR_ID}', false)
